import unittest
from linkedList1 import SinglyLinkedList, DoublyLinkedList
...
class TestObjectMethods(unittest.TestCase): 
    def setUp(self): 
        self.singleLinkList = SinglyLinkedList()
        
        self.singleLinkListData = SinglyLinkedList()
        self.singleLinkListData.append("Cosmo")
        self.singleLinkListData.append("Allie")
        self.singleLinkListData.append("Watson")
        
        self.doubleLinkList = DoublyLinkedList()
        self.doubleLinkListData = DoublyLinkedList()
