...
def test_apply_discount_edge_cases():
    ...
    assert apply_discount(100.00, 99.99) == 0.01

def test_apply_discount_rounded_cases():
    assert apply_discount(100.555, 25) == 75.42
    assert apply_discount(99.999, 10) == 89.99
    assert apply_discount(0.005, 50) == 0.00
    assert apply_discount(100.001, 0.1) == 99.90
