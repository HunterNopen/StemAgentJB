...
def test_future_date_with_leading_zeros():
    assert is_future_date('2026-01-02', '2026-01-01') is True
    assert is_future_date('2026-01-01', '2026-01-01') is False

def test_future_date_with_invalid_format():
    assert is_future_date('2026/01/02', '2026-01-01') is False
    assert is_future_date('2026-01-02', '2026/01/01') is False

def test_future_date_with_non_numeric_characters():
    assert is_future_date('2026-01-02a', '2026-01-01') is False
    assert is_future_date('2026-01-02', '2026-01-01b') is False

def test_future_date_with_special_characters():
    assert is_future_date('2026-01-02!', '2026-01-01') is False
    assert is_future_date('2026-01-02', '2026-01-01@') is False

def test_future_date_with_large_years():
    assert is_future_date('9999-12-31', '9998-12-31') is True
    assert is_future_date('10000-01-01', '9999-12-31') is False