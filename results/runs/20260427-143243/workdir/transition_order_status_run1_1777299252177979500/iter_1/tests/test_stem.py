...
def test_edge_case_unknown_status_with_invalid_action():
...
def test_edge_case_terminal_status_with_invalid_action():
    assert transition_order_status('delivered', 'cancel') == 'delivered'
    assert transition_order_status('cancelled', 'submit') == 'cancelled'

def test_edge_case_invalid_status_with_valid_action():
    assert transition_order_status('invalid_status', 'submit') == 'invalid_status'
    assert transition_order_status('invalid_status', 'approve') == 'invalid_status'
    assert transition_order_status('invalid_status', 'ship') == 'invalid_status'
    assert transition_order_status('invalid_status', 'deliver') == 'invalid_status'
    assert transition_order_status('invalid_status', 'cancel') == 'invalid_status'