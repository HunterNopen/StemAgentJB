...
def test_selection_sort():
    ...
    assert Sort.selection_sort([1, 3, 2, 3, 1]) == [1, 1, 2, 3, 3]
...
def test_insertion_sort():
    ...
    assert Sort.insertion_sort([1, 3, 2, 3, 1]) == [1, 1, 2, 3, 3]
...
def test_merge_sort():
    ...
    assert Sort.merge_sort([1, 3, 2, 3, 1]) == [1, 1, 2, 3, 3]
    assert Sort.merge_sort([1, 3, 2, 2, 1]) == [1, 1, 2, 2, 3]
