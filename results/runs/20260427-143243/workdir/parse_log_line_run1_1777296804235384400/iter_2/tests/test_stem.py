...
def test_edge_case_hours():
    ...
    assert parse_log_line('2024-01-05 23:00:00 INFO Valid hour') == {'datetime': '2024-01-05 23:00:00', 'level': 'INFO', 'message': 'Valid hour'}
...
def test_edge_case_minutes():
    ...
    assert parse_log_line('2024-01-05 12:30:00 INFO Valid middle minute') == {'datetime': '2024-01-05 12:30:00', 'level': 'INFO', 'message': 'Valid middle minute'}
...
def test_edge_case_seconds():
    ...
    assert parse_log_line('2024-01-05 12:10:30 INFO Valid second in the middle') == {'datetime': '2024-01-05 12:10:30', 'level': 'INFO', 'message': 'Valid second in the middle'}

def test_edge_case_combined():
    assert parse_log_line('2024-01-05 12:10:05,123 INFO Combined test') == {'datetime': '2024-01-05 12:10:05,123', 'level': 'INFO', 'message': 'Combined test'}
    assert parse_log_line('2024-01-05 12:10:05,999 INFO Another combined test') == {'datetime': '2024-01-05 12:10:05,999', 'level': 'INFO', 'message': 'Another combined test'}