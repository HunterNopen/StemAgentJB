...
def test_unknown_status():
    ...
    assert transition_order_status('unknown', 'approve') == 'unknown'
    assert transition_order_status('unknown', 'ship') == 'unknown'
    assert transition_order_status('unknown', 'deliver') == 'unknown'

def test_invalid_actions():
    assert transition_order_status('draft', 'approve') == 'draft'
    assert transition_order_status('submitted', 'ship') == 'submitted'
    assert transition_order_status('approved', 'cancel') == 'approved'
    assert transition_order_status('shipped', 'cancel') == 'shipped'
    assert transition_order_status('delivered', 'cancel') == 'delivered'
    assert transition_order_status('cancelled', 'submit') == 'cancelled'
...
def test_edge_cases():
    assert transition_order_status('draft', 'unknown_action') == 'draft'
    assert transition_order_status('submitted', 'unknown_action') == 'submitted'
    assert transition_order_status('approved', 'unknown_action') == 'approved'
    assert transition_order_status('shipped', 'unknown_action') == 'shipped'
    assert transition_order_status('delivered', 'unknown_action') == 'delivered'
    assert transition_order_status('cancelled', 'unknown_action') == 'cancelled'

def test_edge_case_invalid_status():
    assert transition_order_status('unknown', 'submit') == 'unknown'
    assert transition_order_status('unknown', 'approve') == 'unknown'
    assert transition_order_status('unknown', 'ship') == 'unknown'
    assert transition_order_status('unknown', 'deliver') == 'unknown'
...
def test_edge_case_invalid_action():
...
def test_edge_case_terminal_status():
    assert transition_order_status('delivered', 'approve') == 'delivered'
    assert transition_order_status('cancelled', 'approve') == 'cancelled'
    assert transition_order_status('delivered', 'submit') == 'delivered'
    assert transition_order_status('cancelled', 'submit') == 'cancelled'