...
def test_invalid_time_format():
    assert parse_log_line('2024-01-05 12:10 INFO Boot complete') is None
    assert parse_log_line('2024-01-05 12:10:05:123 INFO Boot complete') is None

def test_invalid_time_values():
    assert parse_log_line('2024-01-05 24:00:00 INFO Boot complete') is None
    assert parse_log_line('2024-01-05 12:60:00 INFO Boot complete') is None
    assert parse_log_line('2024-01-05 12:10:60 INFO Boot complete') is None