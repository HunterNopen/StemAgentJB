...
def test_leap_years():
    assert validate_date('2024-02-29') == True
    assert validate_date('2020-02-29') == True
    assert validate_date('1900-02-29') == False
    assert validate_date('2000-02-29') == True
    assert validate_date('2023-02-29') == False

def test_invalid_day_values():
...
def test_edge_case_years():
    assert validate_date('1900-02-29') == False
    assert validate_date('2000-02-29') == True
    assert validate_date('2100-02-29') == False
    assert validate_date('2400-02-29') == True
    assert validate_date('2024-02-29') == True
    assert validate_date('2023-02-29') == False
    assert validate_date('2024-02-28') == True
    assert validate_date('2024-02-30') == False
